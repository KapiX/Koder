...
private:
	...
	void		_GetAttributes(xmlNode* node, int* styleId, int* fgColor, int* bgColor, int* fontStyle);
	void		_SetAttributes(Editor* editor, int styleId, int fgColor, int bgColor, int fontStyle);
};
