...
enum {
	...
	EDIT_MOVESELECTIONUP				= 'mvup',
	EDIT_MOVESELECTIONDOWN				= 'mvdn',
	...
	MAINMENU_VIEW_EXPANDFOLDS			= 'mvef',
	MAINMENU_VIEW_COLLAPSEFOLDS			= 'mvcf',
	MAINMENU_VIEW_COLLAPSETOPFOLDS		= 'mvct',
	...
	MAINMENU_SEARCH_REMOVEBOOKMARKS		= 'mrbk',
